...
const PRODUCTS = [
  {
    ...
    badge: "Sold",
    versions: [
      { id: "v1", label: "Midnight Navy — Hand-dyed Silk", price: "$285" },
      { id: "v2", label: "Champagne Gold — Italian Leather", price: "$340" },
      { id: "v3", label: "Emerald Green — Linen Weave", price: "$265" },
    ],
    description:
      "A full rebind of Fitzgerald's masterpiece in luxurious hand-dyed Japanese silk, with a hand-tooled spine and foil-stamped title. The text block is re-sewn using traditional Coptic binding for a book that lies completely flat when open. End papers feature a custom marbled pattern in complementary tones.",
    details: [
      "Hand-dyed Japanese silk cover",
      "Coptic sewn text block — lays flat",
      "Foil-stamped title & author",
      "Custom marbled end papers",
      "Ribbon bookmark in matching silk",
  ...
  },
  {
    ...
    tagline: "Desert ochre goatskin with blind-tooled sandworm motif",
    coverImage: "https://images.unsplash.com/photo-1589998059171-988d887df646?w=600&q=80",
    badge: "Available",
    versions: [
      { id: "v1", label: "Sand Ochre — Goatskin Leather", price: "$420" },
      { id: "v2", label: "Spice Red — Vegetable-tanned Calf", price: "$480" },
    ],
    description:
      "Inspired by Arrakis itself — this rebind uses desert-ochre Nigerian goatskin with a hand-tooled sandworm motif blind-stamped across the spine. The text is re-set in a period-appropriate typeface and the edges are sprinkled in copper to evoke the spice.",
    details: [
      "Nigerian goatskin leather",
      "Hand-tooled sandworm motif",
      "Copper-sprinkled page edges",
      "Re-sewn with natural linen thread",
      "Raised spine bands",
      "Protective clamshell box available",
    ],
    images: [
  ...
  },
  {
    ...
    author: "Jane Austen",
    tagline: "Regency-era blush linen with hand-painted florals",
    coverImage: "https://images.unsplash.com/photo-1495640388908-05fa85288e61?w=600&q=80",
    badge: "Commission",
    versions: [
      { id: "v1", label: "Blush Linen — Hand-painted Roses", price: "$310" },
      { id: "v2", label: "Sage Green — Embroidered Vines", price: "$360" },
      { id: "v3", label: "Ivory — Blank for personalisation", price: "$280" },
    ],
    description:
      "A delicate rebind befitting Austen's wit and romance. Hand-painted botanical motifs adorn the blush Irish linen covers, each one unique. The spine features five raised bands and a hand-lettered title in gold ink. An ideal gift for an Austen devotee.",
    details: [
      "Irish linen cover",
      "Hand-painted botanical motifs (one-of-a-kind)",
  ...
  },
  {
    ...
    title: "Frankenstein",
    author: "Mary Shelley",
    tagline: "Dark green morrocco leather with gilt lightning detail",
    coverImage: "https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=600&q=80",
    badge: "Available",
    versions: [
      { id: "v1", label: "Midnight Green — Morocco Leather", price: "$395" },
      { id: "v2", label: "Black — Onyx Goatskin", price: "$375" },
    ],
    description:
      "A suitably dramatic rebind for Shelley's gothic masterpiece. Deep hunter-green Morocco leather boards are accented with fine gilt lightning bolt detailing on the corners. The spine is aged with a patina finish and the text edges are stained ink-black.",
    details: [
      "Morocco leather — deep green",
      "Gilt lightning bolt corner details",
      "Patinated spine finish",
      "Ink-black stained page edges",
      "Black silk end papers",
...
const FAQS = [
  {
    q: "What books can you rebind?",
    a: "Almost any paperback or hardcover can be rebound. I work best with standard trade paperbacks and hardcovers. Very small or very large formats may require a custom quote. Bring me your beloved, battered copies — the ones with sentimental value are my favourite commissions.",
  },
  {
    q: "Do I need to send you my own copy of the book?",
    a: "Yes — I rebind your existing copy, preserving the original text block wherever possible. I'll re-sew the signatures and replace the covers entirely. You keep your original reading copy, just dressed in something beautiful.",
  },
  {
    q: "How long does a commission take?",
    a: "Most commissions are completed within 6–10 weeks from receiving your book. Complex designs with hand-painting or embroidery can take up to 14 weeks. I'll give you a specific estimate when we discuss your project.",
  },
  {
    q: "How much does a custom rebind cost?",
    a: "Prices start at around £180/$220 for a cloth or linen rebind, and rise from there depending on materials (leather, silk, hand-tooling) and complexity. Every quote is personalised. See the product pages for example price ranges.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. I ship worldwide via tracked courier. Postage is charged at cost and varies by destination. Books are packaged carefully in archival tissue and a rigid outer box.",
  },
  {
    q: "What if my book is already damaged?",
    a: "That's often why people come to me. I can work with books that have loose pages, detached spines, or water damage. I'll assess what's salvageable during our initial consultation and be honest about what's possible.",
  },
  {
...
const SpineDecor = () => {
  const spines = [
    { h: 200, w: 32, bg: "#2e3a6e" },
    { h: 240, w: 26, bg: "#5b4a2e" },
    { h: 180, w: 38, bg: "#3a2e1e" },
    { h: 260, w: 28, bg: "#2e4a3a" },
    { h: 220, w: 34, bg: "#4a2e3a" },
    { h: 190, w: 30, bg: "#1e2e4a" },
  ];
    ...
    <>
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <h1 className="hero-title">Books deserve a <em>beautiful</em> second life.</h1>
          <p className="hero-sub">
            Custom book rebinding — transforming worn paperbacks and dull hardcovers into heirloom objects using fine leathers, silks, and traditional hand-craft techniques.
          </p>
        </div>
        <SpineDecor />
      </section>
    ...
    <>
      ...
      <div className="detail-layout">
        ...
        <div className="detail-info">
          ...
          <p className="enquire-note">Each piece is made to order. I'll reply within 48 hours.</p>
      ...
      <section className="section">
        <div className="contact-layout">
          <p className="contact-intro">
            Every commission starts with a conversation. Tell me about the book you'd like rebound, what you have in mind, and any deadline or budget to bear in mind. I'll come back to you within 48 hours with thoughts and a quote.
          </p>
          ...
          {submitted ? (
            ...
            <>
              ...
              <div className="field-group">
                <label className="field-label">Book title & author</label>
                <input className="field-input" placeholder="e.g. Middlemarch by George Eliot" value={form.book} onChange={handle("book")} />
              </div>
              <div className="field-group">
                <label className="field-label">Type of project</label>
                <select className="field-select" value={form.type} onChange={handle("type")}>
                  <option value="">Select one…</option>
                  <option>Full rebind — leather</option>
                  <option>Full rebind — cloth / linen</option>
                  <option>Full rebind — silk</option>
                  <option>Repair / restoration</option>
                  <option>Matching a set</option>
              ...
              <div className="field-group">
                ...
                <textarea
                  ...
                  placeholder="Describe what you're imagining — colours, materials, any inspiration. The more detail, the better."
          ...
          <div className="contact-aside">
            <div>
              <p className="aside-item-label">Response time</p>
              <p className="aside-item-val">Within 48 hours</p>
            </div>
            <div>
              <p className="aside-item-label">Lead time</p>
              <p className="aside-item-val">6 – 14 weeks</p>
            </div>
            <div>
              <p className="aside-item-label">Shipping</p>
              <p className="aside-item-val">Worldwide</p>
            </div>
          </div>
        </div>
      </section>
...
export default function App() {
  ...
  return (
    <>
      ...
      <footer>
        <span className="footer-logo">Apple's Custom Books</span>
        <span className="footer-note">Hand-craft bookbinding · Made to order · Worldwide shipping</span>
      </footer>
    </>
  );
}
