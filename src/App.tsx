...
function HomePage({ onProduct }: { onProduct: (p: Product) => void }) {
  return (
    <>
      <section className="hero">
        <div className="hero-text">
          ...
          <h1 className="hero-title">
            Books deserve a <em>beautiful</em> second life.
          </h1>
          <p className="hero-sub">
            Custom book rebinding — transforming worn paperbacks and dull
            hardcovers into heirloom objects using fine leathers, silks, and
      ...
      <div className="detail-layout">
        ...
        <div className="detail-info">
          ...
          <p className="enquire-note">
            Each piece is made to order. I'll reply within 48 hours.
          </p>
      ...
      <section className="section">
        <div className="contact-layout">
          <p className="contact-intro">
            Every commission starts with a conversation. Tell me about the book
            you'd like rebound, what you have in mind, and any deadline or budget
            to bear in mind. I'll come back to you within 48 hours with thoughts
            and a quote.
          </p>
          ...
          {submitted ? (
            ...
            <>
              ...
              <div className="field-group">
                ...
                <input
                  className="field-input"
                  placeholder="e.g. Middlemarch by George Eliot"
                  value={form.book}
                  onChange={handle("book")}
                />
              </div>
              <div className="field-group">
...
type Page = "home" | "product" | "faq" | "contact";
    ...
    <>
      ...
      <nav>
        ...
        <ul className="nav-links">
          <li>
            <button
              className={page === "home" || page === "product" ? "active" : ""}
              onClick={() => nav("home")}
            >
              Works
            </button>
      ...
      <footer>
        ...
        <span className="footer-note">
          Hand-craft bookbinding · Made to order · Worldwide shipping
        </span>
      </footer>
    </>
  );
