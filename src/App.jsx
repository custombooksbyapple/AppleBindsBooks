...
const FAQS = [
  {
    ...
    a: "Currently, the lead time for standard commissions is two weeks and custom commissions is four weeks. For custom commissions, I'll give you a specific estimate when we discuss your project.",
  },
  {
  ...
  },
  {
    ...
    a: "Starting prices are noted on the listing page. For custom commissions, pricing is determined on a project-by-project basis — just reach out and we'll discuss the details and agree on a price before any work begins.",
    hasLink: true,
  },
  {
            ...
            <div key={i} className="faq-item">
              ...
              {open === i && (
                <div className="faq-answer">
                  {f.a.split('\n\n').map((para, j) => (
                    <p key={j} style={{ marginBottom: j < f.a.split('\n\n').length - 1 ? '0.8rem' : 0 }}>
                      {f.hasLink && para.includes('listing page') ? (
                        <>
                          ...
                          . For custom commissions, pricing is determined on a project-by-project basis — just reach out and we'll discuss the details and agree on a price before any work begins.
                        </>
                      ) : para}
                    </p>
                  ))}
  ...
  return (
    <>
      ...
      <main>
        ...
        {page === "faq" && <FAQPage onHome={() => nav("home")} />}
