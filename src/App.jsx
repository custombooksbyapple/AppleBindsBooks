...
const PRODUCTS = [
  ...
  },
  {
    ...
    badge: "Available",
    versions: [
      { id: "v1", label: "To be announced", price: "Starting at $560" },
    ],
    description:
      "A magical collector's set of the Harry Potter series, individually rebound by hand. Get in touch to discuss your vision.",
    details: [
      "All 7 books rebound by hand",
      "Contact to discuss customisation options",
    ],
    images: [
