...
const PRODUCTS = [
  {
    ...
    videoUrls: [
      { url: "/videos/throne-of-glass-cover-pages.mp4", vertical: false, native: true, poster: "/videos/throne-of-glass-cover-pages-poster.jpg", tag: "Cover Pages" },
      { url: "/videos/throne-of-glass-chameleon-htv.mp4", vertical: true, native: true, poster: "/videos/throne-of-glass-chameleon-htv-poster.jpg", tag: "Chameleon HTV Covers" },
    ],
    imageLabels: {
      1: "Terrasen's Version",
      2: "Terrasen's Version",
      3: "Fireheart's Version",
      4: "Dorian's Version",
      5: "Manon's Version",
      6: "Lysandra's Version",
      7: "Maeve's Version",
      8: "Yrene's Version",
    },
  },
  {
    ...
    author: "Sarah J. Maas",
    tagline: "Starting at $300",
    coverImage: "https://i.imgur.com/BPS2TMm.jpeg",
    badge: "Available",
    versions: [
      { id: "v1", label: "Three Book Set: House of Earth and Blood, House of Sky and Breath, House of Flame and Shadow", price: "Starting at $300" },
    ],
    description:
      "For the fans who knew Bryce and Hunt were endgame before either of them did. Each book is individually rebound by hand and finished with chameleon HTV — a colour-shifting material that transforms and shimmers in different lighting, no starlight required.\n\nEvery book features themed end pages, a ribboned bookmark with a crescent moon crystal charm, as well as a detached bookmark handcrafted from the original book's cover.\n\nAs always, you can always message me for different colour themes, changes in quotes, or whatever your heart desires.\n\nChanges to book cloth colour, font colour, and quotes are not subject to additional charges.\n\nPlease understand that these are all handmade and are subject to slight variations and small imperfections.",
    details: [
      "All 3 books in the series rebound by hand",
      "Chameleon HTV background — colour-shifting artwork",
      "Velvet bookmark with crescent moon crystal charm with additional detached bookmark made from the original book's cover",
    ],
    images: [
      "https://i.imgur.com/BPS2TMm.jpeg",
      "https://i.imgur.com/dPAS1bW.jpeg",
      "https://i.imgur.com/KL8xo57.jpeg",
    ],
    videoUrls: [],
  },
  {
  ...
  {
    id: 11,
    title: "The Lord of the Rings Series (Canvas)",
    author: "J.R.R. Tolkien",
    tagline: "Starting at $270",
    coverImage: "https://i.imgur.com/4D9lHIu.jpeg",
    badge: "Available",
    versions: [
      { id: "v1", label: "Three Book Set: Fellowship of the Ring, Two Towers, Return of the King", price: "Starting at $270" },
      { id: "v2", label: "Four Book Set: The Hobbit, Fellowship of the Ring, Two Towers, Return of the King", price: "Starting at $360" },
    ],
    description:
      "One set to rule them all. Each book is individually rebound by hand and finished with hand sprayed edges and printed canvas — custom artwork brought to life on every cover, detailed enough to make even the cartographers of Middle-earth jealous.\n\nEach book comes with custom LOTR themed end pages and a detached bookmark crafted from the original book's cover.\n\nYou can always message me for different colour themes, changes in quotes, or whatever you can dream of — I love bringing custom ideas to life. Changes to font colour and quotes are not subject to additional charges.\n\nPlease understand that these are all handmade and are subject to slight variations and small imperfections.",
    details: [
      "3 or 4 book sets rebound by hand",
      "Custom LOTR end pages",
      "Detached bookmark made from the original book's cover",
    ],
    images: [
      "https://i.imgur.com/4D9lHIu.jpeg",
      "https://i.imgur.com/fMDKOle.jpeg",
      "https://i.imgur.com/JBld1ne.jpeg",
      "https://i.imgur.com/4pbQNUa.jpeg",
    ],
    videoUrls: [],
  },
  {
  ...
  {
    id: 10,
    title: "Moonfall Series",
    author: "Sarah A. Parker",
    tagline: "",
    coverImage: "https://i.imgur.com/tiTynaM.png",
    badge: "Coming Soon",
    versions: [
      { id: "v1", label: "To be announced", price: "TBA" },
    ],
    description:
      "A stunning rebind of Sarah A. Parker's Moonfall series — coming soon. Get in touch to register your interest.",
    details: [
      "Details coming soon",
      "Contact us to register interest",
    ],
    images: [
      "https://i.imgur.com/tiTynaM.png",
    ],
    videoUrls: [],
  },
];
...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .detail-img-label {
      position: absolute; top: 12px; right: 12px;
      background: rgba(45,31,46,0.85); color: var(--gold);
      ...
      <div className="detail-layout">
        ...
        <div className="detail-gallery">
          <div className="detail-main-img-wrap">
            ...
            {product.imageLabels && product.imageLabels[activeImg] && (
              <span className="detail-img-label">{product.imageLabels[activeImg]}</span>
            )}
              ...
              {product.videoUrls.map((v, i) =>
                v.native ? (
                  ...
                  >
                    ...
                    />
                    {v.tag && <span className="video-tag">{v.tag}</span>}
                  </div>
                ) : (
                  <div
...
function ContactPage() {
  const [form, setForm] = useState({ name: "", email: "", book: "", message: "", "bot-field": "" });
        ...
        <div className="contact-layout">
          ...
          {submitted ? (
            ...
            <form onSubmit={submit} name="contact" data-netlify="true" netlify-honeypot="bot-field">
              ...
              <p hidden>
                <label>Don't fill this out: <input name="bot-field" value={form["bot-field"]} onChange={handle("bot-field")} /></label>
              </p>
              <div className="field-group">
                <label className="field-label">Your name</label>
                <input className="field-input" name="name" placeholder="Jane Smith" value={form.name} onChange={handle("name")} required />
              </div>
              <div className="field-group">
                <label className="field-label">Email address</label>
                <input className="field-input" type="email" name="email" placeholder="jane@example.com" value={form.email} onChange={handle("email")} required />
              </div>
              <div className="field-group">
                <label className="field-label">Book/Series</label>
                <input className="field-input" name="book" placeholder="e.g., ACOTAR series" value={form.book} onChange={handle("book")} />
              </div>
              ...
              {error && (
                <p style={{ color: "#b04a4a", fontSize: "0.85rem", marginBottom: "1rem" }}>
                  Something went wrong sending that — please try again, or email me directly at custombooksbyapple@gmail.com.
                </p>
              )}
